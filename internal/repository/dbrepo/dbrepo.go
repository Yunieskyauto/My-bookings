...
// SearchAvailabilityByDateByRoomID returns true if availability exist for roomID, and false if no availability exist
...
// SearchAvailabilityForAllRooms return a slice of available rooms, if any, for any given date
